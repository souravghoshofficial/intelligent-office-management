...
function Dashboard() {
  ...
  const [showSidebar, setShowSidebar] = useState(false); // For small screens
  const employees = [
  ...
  const leaves = [
    {
      name: "Subhra Shaw",
      email: "shawsubhra073@gmail.com",
      status: "Pending",
      type: "Illness",
    },
    {
      name: "Sourav Ghosh",
      email: "souravghose213@gmail.com",
      status: "Approved",
      type: "Illness",
    },
    {
      name: "Tapobrata Sardar",
      email: "tapobrata123@gmail.com",
      status: "Rejected",
      type: "Illness",
    },
  ];
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="flex justify-end">
              <button className="bg-blue-600 text-white px-5 py-2 rounded-lg shadow-md hover:bg-blue-700 transition font-medium">
                ➕ Add Employee
              </button>
            </div>
        ...
        return (
          <div className="space-y-6 p-4">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3">
              ...
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg shadow-md transition duration-300 w-full md:w-auto">
                ➕ Apply for Leave
              </button>
            </div>
                ...
                <tbody>
                  {leaves.map((leave, idx) => (
                    ...
                    >
                      ...
                      <td className="p-3 text-center">{leave.type}</td>
                      <td
                      ...
                      <td className="p-3 text-center">
                        <button className="bg-blue-600 text-white px-4 py-1 rounded-md shadow-md hover:bg-blue-700 transition">
                          View
                        </button>
                      </td>
                    </tr>
    ...
    <div className="min-h-screen grid grid-cols-12 bg-gradient-to-br from-blue-100 to-blue-300">
      ...
      <aside
        className={`
          ...
          col-span-3 md:col-span-2 bg-white/60 backdrop-blur-md shadow-xl 
          border-r border-gray-300 p-4 space-y-4 
          w-56 md:w-full h-auto md:h-screen mt-16 md:mt-0 rounded-r-xl md:rounded-none
          z-20
        `}
      >
